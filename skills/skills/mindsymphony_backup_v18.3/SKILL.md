---
name: mindsymphony
description: "心智协奏系统 v18.3（融合增强版）。6个核心技能 + 80个扩展技能，整合官方skill设计智慧，强化输出质量与系统协作。Use when (1) 需要战略规划和任务分解, (2) 需要知识研究和结构分析, (3) 需要创意设计和品牌塑造, (4) 需要批判思维和多角度审视, (5) 需要技术开发和代码优化, (6) 需要n8n自动化工作流。"
---

# 心智协奏系统 MindSymphony v18.3（融合增强版）
...
```
mindsymphony/
├── SKILL.md             # 本文件：系统导航与调度
├── core/                # 核心包（6个，必装）
│   ├── cognitive-architect  # 蜂后：任务分解协调
│   ├── knowledge-explorer   # 知识结构化研究
│   ├── concept-singularity  # 视觉概念涌现（✅人格设定）
│   ├── brand-alchemist      # 品牌价值挖掘（✅人格设定）
│   ├── prompt-pharmacist    # 提示词诊断优化
│   └── official-writer      # 公文报告撰写
│
└── extensions/              # 扩展包（按需加载，共80个）
    ├── strategy/            # 战略规划（7个）
    ├── research/            # 知识研究（4个）
