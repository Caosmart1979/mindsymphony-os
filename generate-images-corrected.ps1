...
# 图片1：封面图
Write-Host "生成图片1：封面图..." -ForegroundColor Cyan
...
# 图片2：科研体系图
Write-Host "`n生成图片2：科研体系图..." -ForegroundColor Cyan
npx -y bun "C:\Users\13466\.claude\skills\mindsymphony\integrations\baoyu-ai\baoyu-image-gen\scripts\main.ts" `
...
# 图片3：成果总结图
Write-Host "`n生成图片3：成果总结图..." -ForegroundColor Cyan
npx -y bun "C:\Users\13466\.claude\skills\mindsymphony\integrations\baoyu-ai\baoyu-image-gen\scripts\main.ts" `
...
# 图片4：专利技术图
Write-Host "`n生成图片4：专利技术图..." -ForegroundColor Cyan
npx -y bun "C:\Users\13466\.claude\skills\mindsymphony\integrations\baoyu-ai\baoyu-image-gen\scripts\main.ts" `
...
# 图片5：未来规划图
Write-Host "`n生成图片5：未来规划图..." -ForegroundColor Cyan
npx -y bun "C:\Users\13466\.claude\skills\mindsymphony\integrations\baoyu-ai\baoyu-image-gen\scripts\main.ts" `
...
# 图片6：脂质组学技术图
Write-Host "`n生成图片6：脂质组学技术图..." -ForegroundColor Cyan
npx -y bun "C:\Users\13466\.claude\skills\mindsymphony\integrations\baoyu-ai\baoyu-image-gen\scripts\main.ts" `
...
Write-Host "查看生成结果：`n   Get-ChildItem slide-images\*.png | Select-Object Name, Length, LastWriteTime" -ForegroundColor Yellow
